...
# ----- Label helpers (ported from visualize_t2v_gridsearch.py) -----
...
if __name__ == "__main__":
    ...
    for prompt in args.prompt:
        ...
        # Replace folder names with labels for display while preserving metrics mapping
        labeled_md_order = [model_labels.get(m, m) for m in model_list]
        # Temporarily remap keys for printing without altering computations
