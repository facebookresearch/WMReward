...
from pipelines.cosmos2_i2v_guidance_pipeline import Cosmos2VideoToWorldPipeline
...
video = pipe(
    image=image, prompt=prompt, negative_prompt=negative_prompt, generator=torch.Generator().manual_seed(1), num_inference_steps=35
).frames[0]
export_to_video(video, "output_cosmos.mp4", fps=16)
