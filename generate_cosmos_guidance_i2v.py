...
# )
image = load_image("/home/yjianhao/project/video_guidance/store/clean_droid_ood_first_frame.png")

video = pipe(
    image=image, prompt=prompt, negative_prompt=negative_prompt, generator=torch.Generator().manual_seed(1), num_inference_steps=35, num_frames=33, height=480, width=832
).frames[0]
export_to_video(video, "output_cosmos_guidance.mp4", fps=16)
