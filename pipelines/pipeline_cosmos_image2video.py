    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # c_in = c_in.requires_grad_(True)
                # c_skip = c_skip.requires_grad_(True)
                # c_out = c_out.requires_grad_(True)
                ...
                for rep in range(n_repeats + 1):
                    ...
                    if in_guidance_range and rep < n_repeats:
                        ...
                        with torch.enable_grad():
                            ...
                            decoded_full = self.vae.decode(pred_for_decode.to(self.vae.dtype), return_dict=False)[0]
