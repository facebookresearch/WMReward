...
LATE_FRAC      = 0.70       # end   of mid-window (freeze from here)
...
def main():
    ...
    def fk_callback(pipe_obj, step: int, timestep: int, callback_kwargs: dict, **_):
        ...
        # ---- Freeze region: lock to the best particle and replicate; no more scoring/resampling ----
        if step >= FREEZE_AFTER_STEP:
            ...
            # keep weights uniform to avoid any resampling logic downstream
