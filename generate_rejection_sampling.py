...
export_to_video(best_frames, "./temp/best_wan-t2v.mp4", fps=16)  # Export the best frames to video

print(f"Worst Score: {worst_score}")
export_to_video(worst_frames, "./temp/worst_wan-t2v.mp4", fps=16)  # Export the worst frames to video